...
public abstract class AbstractDao<T, ID> implements Dao<T, ID> {
    ...
    public <TT> Page<TT> getFilteredPage(Class<TT> entityClass, List<FilterCondition> filters, String sortBy,
        ...
        TypedQuery<TT> query = entityManager.createQuery(cq);
    ...
    private <TT> List<Predicate> buildPredicates(CriteriaBuilder cb, Root<TT> root, List<FilterCondition> filters) {
