...
public class FundamentalAnalysisScoreRules {
    ...
    public static final List<ScoreRule> MARKET_CAB_RULES = List.of(
            new ScoreRule(Integer.MIN_VALUE, 0, 0, 1),
            new ScoreRule(0, 1000, 25, 1),
            new ScoreRule(1000, 100000, 50, 1),
            new ScoreRule(100000, Integer.MAX_VALUE, 100, 1)
    );

    public static final List<ScoreRule> PRICE_RULES = List.of(
            new ScoreRule(Integer.MIN_VALUE, 20, 100, 1),
            new ScoreRule(20, 50, 50, 1),
            new ScoreRule(50, 75, 25, 1),
            new ScoreRule(75, Integer.MAX_VALUE, 0, 1)
    );

    public static final List<ScoreRule> PE_RULES = List.of(
            new ScoreRule(Integer.MIN_VALUE, 0, 0, 1),
            new ScoreRule(0, 20, 100, 1),
            new ScoreRule(20, 50, 75, 1),
            new ScoreRule(50, 100, 50, 1),
            new ScoreRule(100, Integer.MAX_VALUE, 0, 1)
    );

    public static final List<ScoreRule> DIVIDEND_YIELD_RULES = List.of(
            new ScoreRule(Integer.MIN_VALUE, 0, 0, 1),
            new ScoreRule(0, 10, 25, 1),
            new ScoreRule(10, 25, 50, 1),
            new ScoreRule(25, Integer.MAX_VALUE, 100, 1)
    );

    public static final List<ScoreRule> ROCE_RULES = List.of(
            new ScoreRule(Integer.MIN_VALUE, 0, 0, 1),
            new ScoreRule(0, 10, 25, 1),
            new ScoreRule(10, 20, 50, 1),
            new ScoreRule(20, Integer.MAX_VALUE, 100, 1)
    );
    ...
    public static final List<ScoreRule> QUARTERLY_PROFIT_RULES = List.of(
            new ScoreRule(Integer.MIN_VALUE, 0, 0, 1),
            new ScoreRule(0, 10, 10, 1),
            new ScoreRule(10, 25, 50, 1),
            new ScoreRule(25, 50, 75, 1),
            new ScoreRule(50, Integer.MAX_VALUE, 100, 1)
    );
